    ...
    if 'shortlist' in link_suffix and '-ft' in link_suffix and 'interview' in link_suffix:
        ...
        if len(rolls) == 0:
            ...
            if len(link.text) > 0:
                ...
                #file = s.get( "https://www.placement.iitbhu.ac.in/" + linkObject)
                with s.get("https://www.placement.iitbhu.ac.in/" + linkObject) as r:
                    print("https://www.placement.iitbhu.ac.in/" + linkObject)
                    print("")
                    with open('./data.csv', "wb+") as f:
                        f.write(r.content)
                print(s.get("https://www.placement.iitbhu.ac.in/" + linkObject))
